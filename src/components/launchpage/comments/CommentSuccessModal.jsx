...
export default function CommentSuccessModal ({closeModal, commentStatus}) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 font-basic">
          {/* Overlay background */}
          <div className="fixed inset-0 bg-black opacity-70" onClick={closeModal}></div>

          {/* Modal content */}
          <div className="relative bg-base-5 rounded-xl border border-black py-6 px-10 z-50 max-w-md w-full mx-4 shadow-lg">
